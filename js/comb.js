...
KY_LIBRARY.EXPEDIA_CALENDAR.default_event = function () {
  var that = {},
  presenters = {},
  shell = {},
  templates = {},
  ...
  that.init = function (options) {
    shell = options.shell || EXPEDIA_CALENDAR.default_shell;
    that.listener_name = options.name;
    templates = options.templates;
    reg_number = EXPEDIA_CALENDAR.listener.createNewRegister(that);
...
KY_LIBRARY.EXPEDIA_CALENDAR.hotels = function() {
  var that = Object.create(EXPEDIA_CALENDAR.html_writers);
  var view_element; 
